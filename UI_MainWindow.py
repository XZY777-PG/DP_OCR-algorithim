...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        #标题栏 增加目录3--父项  main_page
        self.ocr_manual_verify = QtWidgets.QAction('Ocr Manual Verify',self.menubar)
        self.menubar.addAction(self.ocr_manual_verify)

        #标题栏 增加目录4--父项  main_page
        ...
        self.select_release_sorter.setGeometry(QtCore.QRect(875, 2, 40, 40))
        self.select_release_sorter.addItems(['1','2','3','4','5','6'])
        self.select_release_sorter.setFont(QtGui.QFont('Times', 15))
        self.select_release_sorter.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.select_release_sorter.setStyleSheet('QComboBox{background-color: white; border-radius: 2px;}')  
        ...
        self.tableView.setGeometry(QtCore.QRect(0, 60, 800, 320))
        ...
        self.tableView.setStyleSheet('border:0px solid black; background-color: white;selection-background-color: gray;')
        self.tableView.setShowGrid(False)
        self.tableView.setFont(QtGui.QFont('Cambria', 10))
        self.tableView.horizontalHeader().setStyleSheet("QHeaderView::section{ border:none;background-color: gray;color: white;height:30px;font-weight: 300;}")
        self.tableView.horizontalHeader().setFont(QtGui.QFont('Cambria', 12))
        ...
        self.tableView1.setGeometry(QtCore.QRect(0, 380, 1420, 620))
        ...
        self.tableView1.verticalHeader().setSectionResizeMode(QtWidgets.QHeaderView.Fixed)
        self.tableView1.verticalHeader().hide()
        self.tableView1.setStyleSheet('border:0px solid black; background-color: white;selection-background-color: gray;font:Times;')
        self.tableView1.setShowGrid(False)
        self.tableView1.setFont(QtGui.QFont('Cambria', 8))
        self.tableView1.horizontalHeader().setStyleSheet("QHeaderView::section{ border:none;background-color: gray;color: white;height:30px;font-weight: 300;}")
        self.tableView1.horizontalHeader().setFont(QtGui.QFont('Cambria', 8))
        ...
        self.tableView2.setGeometry(QtCore.QRect(800, 60, 620, 320))
        ...
        self.tableView2.verticalHeader().setSectionResizeMode(QtWidgets.QHeaderView.Fixed)
        self.tableView2.verticalHeader().hide()
        self.tableView2.setStyleSheet('border:0px solid black; background-color: white;selection-background-color: gray;font:Times;')
        self.tableView2.setFont(QtGui.QFont('Cambria', 8))
        self.tableView2.setShowGrid(False)
        self.tableView2.horizontalHeader().setStyleSheet("QHeaderView::section{ border:none;background-color: gray;color: white;height:30px;font-weight: 300;}")
        self.tableView2.horizontalHeader().setFont(QtGui.QFont('Cambria', 8))
        #model = pandasModel(df3_sorter_output_status)
        #self.tableView2.setModel(model)ss
        ...
        pixmap_image_raw = QtGui.QPixmap('1231.jpg')
        ...
        pixmap_image_result = QtGui.QPixmap('1231.jpg')
        ...
        '''
        manual ocr module AI detect page 
        '''
        self.page_ai_ocr_module_manual = QtWidgets.QWidget()
        self.page_ai_ocr_module_manual.setObjectName("page_ai_ocr_module_manual")

        '''
        add new button to select the image file
        '''
        self.page_ai_ocr_module_manual_button_select_image = QtWidgets.QPushButton(self.page_ai_ocr_module_manual)
        #set the button position and size
        self.page_ai_ocr_module_manual_button_select_image.setGeometry(QtCore.QRect(100, 100, 200, 50))
        #set the button name
        self.page_ai_ocr_module_manual_button_select_image.setObjectName("Select Image")
        #set the button text
        self.page_ai_ocr_module_manual_button_select_image.setText('Select Image')
        #set the button font
        self.page_ai_ocr_module_manual_button_select_image.setFont(QtGui.QFont('Times', 15))
        #set the button cursor
        self.page_ai_ocr_module_manual_button_select_image.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        #set the button style
        self.page_ai_ocr_module_manual_button_select_image.setStyleSheet('QPushButton{background-color: white; border-radius: 5px;}')

        '''
        add new button to load the AI Module    
        '''
        self.page_ai_ocr_module_manual_button_load_ai_module = QtWidgets.QPushButton(self.page_ai_ocr_module_manual)
        #set the button position and size       
        self.page_ai_ocr_module_manual_button_load_ai_module.setGeometry(QtCore.QRect(100, 200, 200, 50))
        #set the button name
        self.page_ai_ocr_module_manual_button_load_ai_module.setObjectName("Load AI Module")
        #set the button text
        self.page_ai_ocr_module_manual_button_load_ai_module.setText('Load AI Module')
        #set the button font
        self.page_ai_ocr_module_manual_button_load_ai_module.setFont(QtGui.QFont('Times', 15))
        #set the button cursor
        self.page_ai_ocr_module_manual_button_load_ai_module.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        #set the button style
        self.page_ai_ocr_module_manual_button_load_ai_module.setStyleSheet('QPushButton{background-color: white; border-radius: 5px;}')

        '''     
        add new button to start the AI Module
        '''
        self.page_ai_ocr_module_manual_button_start_ai_module = QtWidgets.QPushButton(self.page_ai_ocr_module_manual)       
        #set the button position and size
        self.page_ai_ocr_module_manual_button_start_ai_module.setGeometry(QtCore.QRect(100, 300, 200, 50))
        #set the button name
        self.page_ai_ocr_module_manual_button_start_ai_module.setObjectName("Start AI Module")
        #set the button text
        self.page_ai_ocr_module_manual_button_start_ai_module.setText('Start AI Module')
        #set the button font
        self.page_ai_ocr_module_manual_button_start_ai_module.setFont(QtGui.QFont('Times', 15))
        #set the button cursor
        self.page_ai_ocr_module_manual_button_start_ai_module.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        #set the button style
        self.page_ai_ocr_module_manual_button_start_ai_module.setStyleSheet('QPushButton{background-color: white; border-radius: 5px;}')

        '''
        add new label to show the image file path
        '''
        self.page_ai_ocr_module_manual_text_image_path = QtWidgets.QLabel(self.page_ai_ocr_module_manual)
        #set the label position and size    
        self.page_ai_ocr_module_manual_text_image_path.setGeometry(QtCore.QRect(350, 100, 800, 50))
        #set the label name
        self.page_ai_ocr_module_manual_text_image_path.setObjectName('Image Path')
        #set the label text
        self.page_ai_ocr_module_manual_text_image_path.setText("<font color = 'white',>Image Path:None</font>")
        #set the label font
        self.page_ai_ocr_module_manual_text_image_path.setFont(QtGui.QFont('Times', 15))
        #set the label alignment
        self.page_ai_ocr_module_manual_text_image_path.setAlignment(QtCore.Qt.AlignCenter)

        '''
        add new label to show the AI Module status
        '''
        self.page_ai_ocr_module_manual_text_ai_module_status = QtWidgets.QLabel(self.page_ai_ocr_module_manual)
        #set the label position and size
        self.page_ai_ocr_module_manual_text_ai_module_status.setGeometry(QtCore.QRect(350, 200, 800, 50))
        #set the label name
        self.page_ai_ocr_module_manual_text_ai_module_status.setObjectName('AI Module Status')
        #set the label text
        self.page_ai_ocr_module_manual_text_ai_module_status.setText("<font color = 'white',>AI Module Status:</font>")
        #set the label font
        self.page_ai_ocr_module_manual_text_ai_module_status.setFont(QtGui.QFont('Times', 15))
        #set the label alignment
        self.page_ai_ocr_module_manual_text_ai_module_status.setAlignment(QtCore.Qt.AlignCenter)

        '''
        add new label to show the AI Module result
        '''
        self.page_ai_ocr_module_manual_text_ai_module_result = QtWidgets.QLabel(self.page_ai_ocr_module_manual)
        #set the label position and size
        self.page_ai_ocr_module_manual_text_ai_module_result.setGeometry(QtCore.QRect(350, 300, 800, 50))
        #set the label name
        self.page_ai_ocr_module_manual_text_ai_module_result.setObjectName('AI Module Result')
        #set the label text
        self.page_ai_ocr_module_manual_text_ai_module_result.setText("<font color = 'white',>AI Module Result:</font>")
        #set the label font
        self.page_ai_ocr_module_manual_text_ai_module_result.setFont(QtGui.QFont('Times', 15))
        #set the label alignment
        self.page_ai_ocr_module_manual_text_ai_module_result.setAlignment(QtCore.Qt.AlignCenter)

        '''
        add new label to show the Raw Image
        ''' 
        self.page_ai_ocr_module_manual_raw_image = QtWidgets.QLabel(self.page_ai_ocr_module_manual)
        #set the label position and size
        self.page_ai_ocr_module_manual_raw_image.setGeometry(QtCore.QRect(100, 400, 640, 480))
        #set the label name
        self.page_ai_ocr_module_manual_raw_image.setObjectName('Raw Image')
        #Pixamp read the image file 
        pixmap = QtGui.QPixmap('ocr_ai_fodler/module/raw_image.png')
        #resize the image       
        pixmap = pixmap.scaled(640, 480)    
        #set the label show pixmap  
        self.page_ai_ocr_module_manual_raw_image.setPixmap(pixmap)
        #set the label alignment
        self.page_ai_ocr_module_manual_raw_image.setAlignment(QtCore.Qt.AlignCenter)    

        '''
        add new label to show the Result Image
        '''
        self.page_ai_ocr_module_manual_result_image = QtWidgets.QLabel(self.page_ai_ocr_module_manual)
        #set the label position and size
        self.page_ai_ocr_module_manual_result_image.setGeometry(QtCore.QRect(800, 400, 640, 480))
        #set the label name
        self.page_ai_ocr_module_manual_result_image.setObjectName('Result Image')
        #Pixamp read the image file
        pixmap = QtGui.QPixmap('ocr_ai_fodler/module/result_image.png')
        #resize the image
        pixmap = pixmap.scaled(640, 480)
        #set the label show pixmap
        self.page_ai_ocr_module_manual_result_image.setPixmap(pixmap)
        #set the label alignment
        self.page_ai_ocr_module_manual_result_image.setAlignment(QtCore.Qt.AlignCenter)
        ...
        '''
        self.page_ai_ocr_module_manual.setAutoFillBackground(True)
        self.page_ai_ocr_module_manual.setPalette(palette)
        self.stackedWidget.addWidget(self.page_ai_ocr_module_manual)
